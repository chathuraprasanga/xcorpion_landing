                    ...
                    <div className="mx-auto max-w-7xl px-6 pb-10 pt-16">
                        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                            <div className="space-y-4">
                                ...
                                <span>
                                    <img src={logo} alt="XCORPION Logo"
                                         width="64" height="64" className="w-16"/>
                                </span>
                                            <span className="text-white">XCORPION</span>
                                        </div>
                                ...
                                <div className="md:grid md:grid-cols-2 md:gap-8">
                                    <div>
                                        ...
                                        <ul role="list" className="mt-6 space-y-4">
                                            <li>
                                                <a href="/aiplatform"
                                                   className="text-md leading-6 text-gray-300 hover:text-gray-50">AI
                                                    Platform
                                                </a>
                                            </li>
                                            <li>
                                ...
                                <div className="md:grid md:grid-cols-2 md:gap-8">
                                    <div>
                                        ...
                                        <ul role="list" className="mt-6 space-y-4">
                                            ...
                                            <li>
                                                <a href="/casestudies"
                                                   className="text-md leading-6 text-gray-300 hover:text-gray-50">Case
                                                    Studies
                                                </a>
                                            </li>
                                            <li>
